...
public abstract class Hilt_RotasMotoristaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RotasMotoristaFragment() {
    super();
  }

  Hilt_RotasMotoristaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RotasMotoristaFragment_GeneratedInjector) this.generatedComponent()).injectRotasMotoristaFragment(UnsafeCasts.<RotasMotoristaFragment>unsafeCast(this));
    }
  }
