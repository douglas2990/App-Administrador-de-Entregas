...
public abstract class Hilt_MinhaAgendaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MinhaAgendaFragment() {
    super();
  }

  Hilt_MinhaAgendaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MinhaAgendaFragment_GeneratedInjector) this.generatedComponent()).injectMinhaAgendaFragment(UnsafeCasts.<MinhaAgendaFragment>unsafeCast(this));
    }
  }
