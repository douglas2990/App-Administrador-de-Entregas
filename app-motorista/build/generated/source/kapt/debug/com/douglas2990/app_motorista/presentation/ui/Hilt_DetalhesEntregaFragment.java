...
public abstract class Hilt_DetalhesEntregaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetalhesEntregaFragment() {
    super();
  }

  Hilt_DetalhesEntregaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetalhesEntregaFragment_GeneratedInjector) this.generatedComponent()).injectDetalhesEntregaFragment(UnsafeCasts.<DetalhesEntregaFragment>unsafeCast(this));
    }
  }
