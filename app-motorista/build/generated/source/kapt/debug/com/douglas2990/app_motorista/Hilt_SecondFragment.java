...
public abstract class Hilt_SecondFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SecondFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SecondFragment_GeneratedInjector) this.generatedComponent()).injectSecondFragment(UnsafeCasts.<SecondFragment>unsafeCast(this));
    }
  }
